  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Статистика доставок</h2>
        <div className="flex items-center gap-8 text-center">
          <div>
            <p className="text-3xl font-bold text-green-600">{stats?.delivered ?? 0}</p>
            <p className="text-sm text-gray-500 mt-1">Доставлено</p>
          </div>
          <div className="h-12 w-px bg-gray-200" />
          <div>
            <p className="text-3xl font-bold text-blue-600">{stats?.in_transit ?? 0}</p>
            <p className="text-sm text-gray-500 mt-1">В пути</p>
          </div>
          <div className="h-12 w-px bg-gray-200" />
          <div>
            <p className="text-3xl font-bold text-yellow-600">{stats?.new_orders ?? 0}</p>
            <p className="text-sm text-gray-500 mt-1">Ожидают</p>
          </div>
        </div>
      </div>
    </div>
